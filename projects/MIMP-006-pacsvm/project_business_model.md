...
modified: 2026-08-13T13:40:21.747Z
---

> ## ⚠ BANNED FRAMING in the description above; business model superseded
>
> The frontmatter calls this a **"DICOM teleradiology platform."** *Never teleradiology* is a standing hard line in the DH PACS brand voice — DH PACS does not compete with reporting services and the hospital's radiologist workflow is untouched.
>
> The business model below ("patients can't access their data") was superseded on 2026-08-03: the category is the **Advanced Connected Imaging Network**, patient access is the *mechanism* rather than the claim, and DHS sells to the **surgeon's** need for post-processed studies.
>
> **The technical description below remains accurate** — data flow, Orthanc-per-site, Tailscale tunnel. Only the framing is superseded.
>
