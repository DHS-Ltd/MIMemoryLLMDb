...
- [Product Architecture & Market Positioning](project-dh-pacs-product.md) â€” What DH PACS actually does: images + report merged into complete patient record; NOT teleradiology; new market category
- [Market Strategy & Sales Chain](project-dh-pacs-market-strategy.md) â€” Two angles (patient data ownership / film replacement), three-layer sales chain (IT â†’ Management â†’ Clinical), Ibn Sina as master proof point
